...
const staticTeam = [
    ...
    { name: 'Roberto Solano',       role: 'CEO & Founder | Google Specialist',         color: '#FACC15', avatar: '/images/team/roberto.jpg',    tag: 'Founder', stats: { xp: '12+ Anni', stat1: 'Google Ads', stat2: 'Analisi Dati', bio: 'Ottimizza le performance chirurgicamente, trasformando i click in reale valore di business.' } },
    { name: 'Giuseppe Savino',      role: 'CEO & Founder | Business Developer',        color: '#FACC15', avatar: '/images/team/beppe.jpg',      tag: 'Founder', stats: { xp: '10+ Anni', stat1: 'Networking', stat2: 'Sviluppo', bio: 'Costruisce relazioni di valore ed espande le opportunità di business dell\'agenzia.' } },
